...
contract Verification {
    ...
    function verifyTitleHash(bytes32 id, bytes32 candidateHash) public view returns (bool) { return false; /* TODO(member3) */ }
    function verifyTitle(bytes32 id, bytes32 candidateHash) external view returns (bool valid, IAttestationRegistry.Status status, address owner, address issuer) {
        // TODO(member3): valid = hash matches AND Active; return tuple.
