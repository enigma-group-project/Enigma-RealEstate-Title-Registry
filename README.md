# Enigma-RealEstate-Title-Registry
...
- 🌐 **Live GUI (GitHub Pages):** <https://enigma-group-project.github.io/Enigma-RealEstate-Title-Registry/>
...
- 📊 **Tracker:** <https://enigma-group-project.github.io/Enigma-RealEstate-Title-Registry/tracker/>
...
|---|-------|----------|-----------------|---------------|---------------|
| 1 | Notary Registration | `contracts/IssuerRegistry.sol` | `forge test --match-contract IssuerRegistryTest` | `frontend/src/modules/issuer/` | `registerNotary · deregisterNotary · transferRegistrar` |
...
|------|-----|-------------|
| Issuer | Land Registry Office | create / update / revoke TitleDeed |
| Owner | Property Owner | transfer their own TitleDeed |
| Verifier | Bank/Buyer/Title Insurer | read-only verification |
...
|--------|-------------|--------|----------|
| member1 | Registry-Office Registration (`IssuerRegistry`) | `feature/member1-issuer-registration` | _screenshot / test output_ |
