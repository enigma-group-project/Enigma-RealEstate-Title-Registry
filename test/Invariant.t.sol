...
contract InvariantTest is Test {
    ...
    /// @dev Authorization property: a non-Notary can NEVER issue, for any inputs.
    function testFuzz_OnlyTestCenterCanIssue(address caller, bytes32 id, bytes32 h, address owner_) public {
        ...
        vm.assume(!issuers.isNotary(caller));
        vm.prank(caller);
        vm.expectRevert(RecordRegistry.NotNotary.selector);
        records.registerTitle(id, h, "cid", owner_, "meta");
    }
